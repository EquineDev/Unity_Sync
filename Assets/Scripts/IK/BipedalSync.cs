...
public class BipedalSync : NetworkBehaviour
{
    ...
    [Header("Left Arm")]
    [SerializeField] private Transform m_upperArmL;
    [SerializeField] private Transform m_lowerArmL;
    [SerializeField] private Transform m_handL;
    
    [Header("Right Arm")]
    [SerializeField] private Transform m_upperArmR;
    [SerializeField] private Transform m_lowerArmR;
    [SerializeField] private Transform m_handR;
    
    [Header("Left Leg")]
    [SerializeField] private Transform m_upperLegL;
    [SerializeField] private Transform m_lowerLegL;
    [SerializeField] private Transform m_FootL;
    
    [Header("Right Leg")]
    [SerializeField] private Transform m_upperLegR;
    [SerializeField] private Transform m_lowerLegR;
    [SerializeField] private Transform m_FootR;
    ...
    // Left Arm
        ...
        leftLowerArmNode.AddChild(leftHandNode);
    ...
    // Right Arm
        ...
        rightLowerArmNode.AddChild(rightHandNode);
    ...
    // Left Leg
        ...
        leftLowerLegNode.AddChild(leftFootNode);
    ...
    // Right Leg
        ...
        rightLowerLegNode.AddChild(rightFootNode);
